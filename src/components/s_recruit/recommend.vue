<template>
  <div id="recommend">
    <el-breadcrumb separator=">" style="margin:0 0 20px 20px;">
      ...
      <el-breadcrumb-item>人才捕手</el-breadcrumb-item>
    </el-breadcrumb>
    <div class="content">
    ...
    <div class="left">
      ...
      <div class="avatar-uploader" @click="showImgUploadclick" :class="{'border_color_fff':imageUrl}">
        <div class="el-upload">
          <img v-if="imageUrl" :src="imageUrl" class="avatar">
          <i v-else class="el-icon-plus avatar-uploader-icon"></i>
        </div>
  ...
  methods:{
    ...
    handleAvatarSuccess(response,file,fileList){
      ...
      if (response.code == 0) {
        ...
        self.imageUrlShow=response.data.fileInfoList[0].url;
      } else {
    ...
    getPosistionList(){
      ...
      var method="positionRecommend/getPosistionList",
          param=JSON.stringify({recomType:'2'}),
...
<style scoped>
.left{margin-right: 400px;background-color: #fff;padding: 20px;min-height: 645px;border-right: 1px solid #ddd;}
.left h2{font-weight: 400;font-size: 14px;margin-bottom:20px;}
.left h2 em{font-size: 12px;margin-left: 20px;color: #99A9BF;}
.left h2 p{font-size: 12px;margin-left: 100px;color: #99A9BF;}
.right{width: 360px;float: right;background-color: #fff;padding:20px;min-height: 600px;}
...
<style>
  #recommend .avatar-uploader .el-upload {
  ...
  #recommend .avatar-uploader .el-upload:hover {
    border-color: #20a0ff;
  }#recommend .border_color_fff .el-upload:hover {
    border-color: #fff;
  }
  #recommend .avatar-uploader-icon {
    font-size: 28px;
    color: #8c939d;
    width: 470px;
    height: 250px;
  ...
  #recommend .el-dialog.el-dialog--tiny{width:500px;}
  #recommend .border_color_fff .el-upload{border-color:#fff;}
